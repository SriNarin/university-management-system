<div class="w-full flex items-center justify-center" style="display: flex !important; justify-content: center !important; align-items: center !important;">
    ...
    @if($getRecord() && $getRecord()->is_timetable_published)
        <a 
            href="{{ route('student.timetable.print', $getRecord()->id) }}" 
            target="_blank"
            onclick="event.stopPropagation();" 
            title="Get Schedule Certificate File"
    ...
    @else
        <span style="color: #9ca3af; font-size: 12px; font-style: italic;" class="select-none">
